...
from Himawari import OWNER_ID,dispatcher,REDIS,DEV_USERS
...
def anime(update, context):
    ...
    if len(search) == 1:
        ...
        video = "https://telegra.ph/file/5e07edf95a413d202ae85.mp4",
...
def manga(update, context):
    ...
    if len(search) == 1:
        update.effective_message.reply_video(
        video = "https://telegra.ph/file/19ff6f4fe726e21936fea.mp4",
