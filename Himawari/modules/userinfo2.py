...
from Himawari.__main__ import STATS, TOKEN, USER_INFO
...
STATS_HANDLER = CommandHandler(["okstats", "okstatistics"], stats, run_async=True)
ID_HANDLER = DisableAbleCommandHandler("okid", get_id, run_async=True)
GIFID_HANDLER = DisableAbleCommandHandler("okgifid", gifid, run_async=True)
INFO_HANDLER = DisableAbleCommandHandler("info", info, run_async=True)

SET_ABOUT_HANDLER = DisableAbleCommandHandler("oksetme", set_about_me, run_async=True)
GET_ABOUT_HANDLER = DisableAbleCommandHandler("okme", about_me, run_async=True)
